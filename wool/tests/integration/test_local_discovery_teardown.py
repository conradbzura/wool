...
if len(sys.argv) > 2:
    ...
    # a check-then-create implementation, which is the race being removed.
...
class TestCrossProcessOwnership:
    def test___enter___should_raise_when_another_process_owns_the_namespace(self):
        ...
        try:
            ...
            # Assert — the claim was refused, not silently downgraded. Match
            # whole lines: the rejection's message also contains "claimed".

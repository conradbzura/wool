...
# Public form of the colliding key, exposed so test assertions can
# match the wool.ContextVarCollision message text without reaching
# into the underscored constants.
COLLIDING_KEY = f"{_COLLISION_KEY_NAMESPACE}:{_COLLISION_KEY_NAME}"

...
class TestLocalDiscoveryPublisher:
    ...
    async def test_publish_should_bound_registrations_by_capacity(
        ...
        Then:
            It should accept all C and raise RuntimeError matching "No
            available slots" on the (C+1)th.
        """
    ...
    async def test_publish_should_reject_second_worker_when_capacity_is_one(
        ...
        Then:
            It should register the first and raise RuntimeError matching
            "No available slots" on the second; page rounding grants no
            extra slot.
        """
        # Arrange
    ...
    async def test_publish_should_reject_worker_beyond_default_capacity(self, namespace):
        ...
        Then:
            It should accept all 128 and raise RuntimeError matching "No
            available slots" on the 129th, pinning the documented
            default of 128.
        """
        # Arrange
        workers = [
    ...
    async def test_publish_should_enforce_owner_capacity_when_non_owner_declares_larger(
        ...
        When:
            ...
            second
        Then:
            It should admit the first and raise RuntimeError matching "No
            available slots" on the second — the owner's stamped cap of 1
            governs, and the non-owner's declared 100 is ignored.
        """
        # Arrange
    ...
    async def test_publish_should_bound_registrations_when_workers_cycle_at_capacity(
        ...
        Then:
            ...
            are live and raise "No available slots" when three are live —

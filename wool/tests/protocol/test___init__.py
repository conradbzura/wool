...
class TestProtocolPackage:
    ...
    def test_wire_submodule_accessible(self):
        ...
        """
        assert hasattr(protocol, "wire")
        assert hasattr(protocol.wire, "Request")
        assert hasattr(protocol.wire, "Response")
        assert hasattr(protocol.wire, "WorkerServicer")
    ...
    def test_add_to_server_mapping(self):
        ...
        """
        assert protocol.wire.WorkerServicer in protocol.add_to_server
        assert (
            protocol.add_to_server[protocol.wire.WorkerServicer]
            is protocol.wire.add_WorkerServicer_to_server
        )

...
from wool.protocol import wire
...
class TestExports:
    """Tests for :py:mod:`wool.protocol.wire` export completeness."""

    @pytest.mark.parametrize("name", EXPECTED_MESSAGE_EXPORTS + EXPECTED_GRPC_EXPORTS)
    def test_exports_accessible(self, name):
        """Test that each expected name is importable from wire.

        Given:
            A name from the expected public API.
        When:
            Accessed as an attribute of the wire module.
        Then:
...
class TestMessageConstruction:
    ...
    def test_nack_with_reason(self):
        ...
        """
        nack = wire.Nack(reason="version mismatch")
...
class TestOneofBehavior:
    ...
    def test_request_task_oneof(self):
        ...
        """
        req = wire.Request(task=wire.Task(id="1"))
    ...
    def test_request_next_oneof(self):
        ...
        """
        req = wire.Request(next=wire.Void())
    ...
    def test_request_send_oneof(self):
        ...
        """
        req = wire.Request(send=wire.Message(dump=b"data"))
    ...
    def test_request_throw_oneof(self):
        ...
        """
        req = wire.Request(throw=wire.Message(dump=b"exc"))
    ...
    def test_response_ack_oneof(self):
        ...
        """
        resp = wire.Response(ack=wire.Ack(version="1.0.0"))
    ...
    def test_response_nack_oneof(self):
        ...
        """
        resp = wire.Response(nack=wire.Nack(reason="denied"))
    ...
    def test_response_result_oneof(self):
        ...
        """
        resp = wire.Response(result=wire.Message(dump=b"ok"))
    ...
    def test_response_exception_oneof(self):
        ...
        """
        resp = wire.Response(exception=wire.Message(dump=b"err"))

...
class WorkerProxy:
    ...
    **Quorum gate:**
    ...
    async def _worker_sentinel(self):
        ...
        constructed: whatever a construction-path subscription filter
        matches on, the gate does not assume it has already screened
        for compatibility. An event whose metadata fails the combined
